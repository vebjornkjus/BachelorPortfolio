...
const MemberCard = ({ name, role, bio, image, linkedin, github }) => {
  return (
    <div className="glass-card-interactive rounded-xl overflow-hidden">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center space-x-4">
          <a
            ...
            className="text-cyan-400 hover:text-cyan-300 transition-colors duration-200 glass-focus-ring rounded p-1"
