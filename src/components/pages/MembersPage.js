              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-center space-x-4">
                  <a
                    ...
                    className={`flex items-center space-x-2 px-4 py-3 rounded-lg bg-gradient-to-r ${selectedMember.primaryColor} bg-opacity-20 border border-white/20 hover:bg-opacity-30 transition-all duration-300 group`}
                  >
